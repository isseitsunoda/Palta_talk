...
class Dictionary:
    ...
    def load_pattern(self):
        ...
        # ptn 正規表現のパターン
        # prs 応答例
        # ParseItemオブジェクトを生成(引数はptn、ptr)して
    ...
    def study(self, input, parts):
        """study_random()とstudy_pattern()、study_template()を呼ぶ
        ...
        # インプット文字列を解析結果を引数に、パターン辞書の登録メソッドを呼ぶ
...
class ParseItem:
    ...
    def __init__(self, pattern, phrases):
        ...
        :param phrases: 応答例
        """
        # 辞書のパターン部分にSEPARATORをパターンマッチさせる
